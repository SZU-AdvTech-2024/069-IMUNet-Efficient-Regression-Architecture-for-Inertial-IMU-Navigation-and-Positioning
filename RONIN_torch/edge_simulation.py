...
def convert_onnx_tflite (onnx_path , tflite_path , graph_path):
    ...
    # converter = tf.compat.v1.lite.TFLiteConverter.from_frozen_graph('/home/behnam/Documents/SoftCom/out/saved_model.pb',tf_rep.inputs,tf_rep.outputs)
...
if __name__ == '__main__':
    ...
    # onnx_path = current_dir + '/RONIN_torch/Test_out/proposed/' + args.arch + '/model.onnx'
    # if os.path.exists(onnx_path):
    #     tflite_path =  current_dir + '/RONIN_torch/Test_out/proposed/' +\
    #                             args.arch + '/tflite/' + args.arch + '.tflite'
    #     if not os.path.exists(tflite_path):
            
    #         graph_path = current_dir + '/RONIN_torch/Test_out/proposed/' +\
    #                                 args.arch + '/tflite/'
