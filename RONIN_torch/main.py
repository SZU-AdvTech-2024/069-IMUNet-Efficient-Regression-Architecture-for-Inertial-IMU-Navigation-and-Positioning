...
from torch.utils.tensorboard import SummaryWriter   # 使用torch的tensorboard
...
def train(args, **kwargs):
    ...
    if args.continue_from is not None and osp.exists(args.continue_from):
        ...
        checkpoints = torch.load(args.continue_from, map_location='cuda:0')
...
if __name__ == '__main__':
    ...
    current_dir += '/IMUNet'
    # 加载预训练模型
    args.continue_from = current_dir + '\\RONIN_torch\\pretrain_model_backup\\EfficientNet\\proposed\\checkpoints\\checkpoint_best.pt'
